...
mod raw_keys {
	...
	pub const KEY_NSPIRE_THETA: ndless_sys::t_key = key_t_pad!(0x10, 0x400, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_QUES: ndless_sys::t_key = key_t_pad!(0x14, 0x001, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_COLON: ndless_sys::t_key = key_t_pad!(0x16, 0x001, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_II: ndless_sys::t_key = key_t_pad!(0x16, 0x400, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	pub const KEY_NSPIRE_QUOTE: ndless_sys::t_key = key_t_pad!(0x18, 0x001, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_COS: ndless_sys::t_key = key_t_pad!(0x18, 0x020, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	pub const KEY_NSPIRE_I: ndless_sys::t_key = key_t_pad!(0x18, 0x040, 0x16, 0x010);
	pub const KEY_NSPIRE_SIN: ndless_sys::t_key = key_t_pad!(0x18, 0x080, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_GTHAN: ndless_sys::t_key = key_t_pad!(0x18, 0x400, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_FRAC: ndless_sys::t_key = key_t_pad!(_KEY_DUMMY_ROW, _KEY_DUMMY_COL, 0x1A, 0x100);
	...
	pub const KEY_NSPIRE_LTHAN: ndless_sys::t_key = key_t_pad!(0x1A, 0x400, _KEY_DUMMY_ROW, _KEY_DUMMY_COL);
	...
	pub const KEY_NSPIRE_DOC: ndless_sys::t_key = key_t_pad!(_KEY_DUMMY_ROW, _KEY_DUMMY_COL, 0x1C, 0x008);
	pub const KEY_NSPIRE_TRIG: ndless_sys::t_key = key_t_pad!(_KEY_DUMMY_ROW, _KEY_DUMMY_COL, 0x12, 0x200);
